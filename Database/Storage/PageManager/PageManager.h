...
protected:
  ...
  static void
  AllocateMemoryBasedOnSystemPageType(Pages::Page **page,
                                      const Pages::PageHeader &pageHeader);
  static void
  AllocateMemoryBasedOnPageType(Pages::Page **page,
                                const Pages::PageHeader &pageHeader);
  void OpenExtent(const Constants::extent_id_t &extentId,
  ...
  Pages::Page *GetSystemPage(const Constants::page_id_t &pageId,
                             const string &filename);
  Pages::Page *GetSystemPage(const Constants::page_id_t &pageId,
                             const Constants::extent_id_t &extentId);
  static void SetReadFilePointerToOffset(fstream *file,
                                         const streampos &offSet);
  static void SetWriteFilePointerToOffset(fstream *file,
                                          const streampos &offSet);
  static Pages::PageHeader
  GetPageHeaderFromFile(const vector<char> &data,
                        Constants::page_offset_t &offSet);
  bool IsPageCached(const Constants::page_id_t &pageId);
  void MovePageToFrontOfSystemList(Pages::Page *page,
                                   const Constants::page_id_t &pageId,
                                   const string &filename);
  void MovePageToFrontOfSystemList(Pages::Page *page,
                                   const Constants::page_id_t &pageId);
  void MovePageToFrontOfList(Pages::Page *page,
                             const Constants::page_id_t &pageId,
                             const string &filename);
  void MovePageToFrontOfList(Pages::Page *page,
                             const Constants::page_id_t &pageId);
  void ReadSystemPageFromFile(Pages::Page *page, const vector<char> &buffer,
                              const Constants::page_id_t &pageId,
                              Constants::page_offset_t &offSet, fstream *file);
  void ReadPageFromFile(Pages::Page *page, const vector<char> &buffer,
                        const DatabaseEngine::StorageTypes::Table *table,
                        Constants::page_offset_t &offSet, fstream *file);
...
public:
  ...
  Pages::Page *GetPage(const Constants::page_id_t &pageId,
                       const Constants::extent_id_t &extentId,
                       const DatabaseEngine::StorageTypes::Table *table);
  ...
  Pages::LargeDataPage *
  GetLargeDataPage(const Constants::page_id_t &pageId,
                   const Constants::extent_id_t &extentId,
                   const DatabaseEngine::StorageTypes::Table *table);
  Pages::GlobalAllocationMapPage *
  CreateGlobalAllocationMapPage(const string &filename,
                                const Constants::page_id_t &pageId);
  Pages::GlobalAllocationMapPage *
  CreateGlobalAllocationMapPage(const Constants::page_id_t &pageId);
  Pages::GlobalAllocationMapPage *
  GetGlobalAllocationMapPage(const Constants::page_id_t &pageId);
  Pages::IndexAllocationMapPage *
  CreateIndexAllocationMapPage(const Constants::table_id_t &tableId,
                               const Constants::page_id_t &pageId,
                               const Constants::extent_id_t &startingExtentId);
  Pages::IndexAllocationMapPage *
  GetIndexAllocationMapPage(const Constants::page_id_t &pageId);
  Pages::PageFreeSpacePage *
  CreatePageFreeSpacePage(const string &filename,
                          const Constants::page_id_t &pageId);
  Pages::PageFreeSpacePage *
  CreatePageFreeSpacePage(const Constants::page_id_t &pageId);
  Pages::PageFreeSpacePage *
  GetPageFreeSpacePage(const Constants::page_id_t &pageId);
