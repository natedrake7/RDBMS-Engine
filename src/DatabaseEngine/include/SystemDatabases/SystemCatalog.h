...
namespace DatabaseEngine {
  ...
  class SystemCatalog {
    ...
    static Headers::ColumnStatistics ToColumnStatistics(const StorageTypes::Row& row, const DataType& columnType);
    static Headers::ColumnHistograms ToColumnHistograms(const StorageTypes::Row& row, const DataType& columnType);
