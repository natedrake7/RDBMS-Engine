...
namespace QueryPipeline {
    ...
    public:
        ...
        antlrcpp::Any visitJsonExpression(SQLParser::JsonExpressionContext* context) override;

        antlrcpp::Any visitJsonAccessor(SQLParser::JsonAccessorContext* context) override;

        antlrcpp::Any visitJsonObjectAccessor(SQLParser::JsonObjectAccessorContext* context) override;
