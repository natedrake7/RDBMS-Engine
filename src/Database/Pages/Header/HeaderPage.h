...
namespace Pages {
    ...
    public:
        ...
        ~HeaderPage() override;
        void WritePageToFile(std::fstream* filePtr) override;
        void ReadFromDisk(const std::vector<char>& data, const DatabaseEngine::StorageTypes::Table* table, Constants::page_offset_t& offSet, std::fstream* filePtr) override;
