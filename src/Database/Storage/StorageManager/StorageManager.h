...
protected:
  ...
  static std::string CreateKey(const std::string& filename, const Constants::page_id_t &pageId);
  ...
  Pages::Page* OpenExtent(const Constants::page_id_t& pageId, const std::string& filename, const Constants::extent_id_t &extentId, const DatabaseEngine::StorageTypes::Table *table);
